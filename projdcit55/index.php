...
<body>
            ...
            <div class="col-12 d-flex flex-column align-items-center">
                <div class="login-card-split animate-login-card">
                    <div class="login-card-left">
                        ...
                        <h2>Register</h2>
                        <p>Register a ProjectLisensya account to view information regarding your license.</p>
                    </div>
                    <div class="login-card-right">
                        <h3 class="mb-4 text-primary text-center"><i class="bi bi-person-plus"></i> Register</h3>
                        <form method="post" action="_functions.php" class="w-100 animate-login-form" autocomplete="off">
                            ...
                            <button type="submit" class="btn btn-primary w-100 animate-login-btn" name="register-driver"><i class="bi bi-person-plus"></i> Register</button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <script>
        const form = document.querySelector('.animate-login-form');
        form.addEventListener('submit', function(e) {
            const passwordInput = document.getElementById('password');
            if (passwordInput.value.length < 8) {
                e.preventDefault();
                passwordInput.setCustomValidity('A minimum of 8 characters is required for passwords.');
            }
        });
    </script>
