            ...
            <div class="col-12 d-flex flex-column align-items-center">
                <div class="login-card-split animate-login-card">
                    <div class="login-card-left">
                        ...
                        <h2>Admin Access</h2>
                        <p>Sign in to access the ProjectLisensya admin dashboard and manage the system securely.</p>
                    </div>
                    <div class="login-card-right">
                        <h3 class="mb-4 text-primary text-center"><i class="bi bi-person-gear"></i> Admin Login</h3>
                        <form method="post" action="_functions.php" class="w-100 animate-login-form">
                            <div class="mb-3">
                                <label for="username" class="form-label"><i class="bi bi-person form-icon"></i> Username</label>
                            ...
                            <button type="submit" name="adminLogin" value="true" class="btn btn-primary w-100 animate-login-btn"><i class="bi bi-box-arrow-in-right"></i> Login</button>
                        </form>
                    </div>
                </div>
            </div>
