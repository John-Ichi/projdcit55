            ...
            <div class="col-12 d-flex flex-column align-items-center">
                <div class="login-card-split animate-login-card">
                    <div class="login-card-left">
                        ...
                        <h2>Welcome Back!</h2>
                        <p>Sign in to access your ProjectLisensya account and manage your license information securely.</p>
                    </div>
                    <div class="login-card-right">
                        <h3 class="mb-4 text-primary text-center"><i class="bi bi-person-circle"></i> User Login</h3>
